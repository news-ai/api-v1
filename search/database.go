...
func searchESMediaDatabase(elasticQuery interface{}) (interface{}, int, int, error) {
	hits, err := elasticMediaDatabase.QueryStruct(elasticQuery)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func searchESMediaDatabasePublication(elasticQuery interface{}) (interface{}, int, int, error) {
	hits, err := elasticMediaDatabasePublication.QueryStruct(elasticQuery)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func searchESContactsDatabase(elasticQuery elastic.ElasticQuery) (interface{}, int, int, error) {
	hits, err := elasticContactDatabase.QueryStruct(elasticQuery)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func SearchEnhanceForEmailVerification(r *http.Request, email string) (EnhanceEmailVerificationResponse, error) {
	client := http.Client{}
...
func SearchCompanyDatabase(r *http.Request, url string) (EnhanceFullContactCompanyResponse, error) {
	client := http.Client{}
...
func SearchContactDatabase(r *http.Request, email string) (EnhanceFullContactProfileResponse, error) {
	client := http.Client{}
...
func SearchContactVerifyDatabase(r *http.Request, email string) (EnhanceFullContactProfileVerifyResponse, error) {
	client := http.Client{}
...
func SearchContactDatabaseForMediaDatbase(r *http.Request, email string) (pitchModels.MediaDatabaseProfile, error) {
	client := http.Client{}
	getUrl := "https://enhance.newsai.org/fullcontact/" + email
...
func SearchContactInMediaDatabase(r *http.Request, email string) (pitchModels.MediaDatabaseProfile, error) {
	client := http.Client{}
...
func SearchESMediaDatabasePublications(r *http.Request) (interface{}, int, int, error) {
	...
	return searchESMediaDatabasePublication(elasticQuery)
}

func SearchESMediaDatabase(r *http.Request) (interface{}, int, int, error) {
	offset := gcontext.Get(r, "offset").(int)
	limit := gcontext.Get(r, "limit").(int)
	...
	return searchESMediaDatabase(elasticQuery)
}

func SearchContactsInESMediaDatabase(r *http.Request, searchQuery SearchMediaDatabaseQuery) (interface{}, int, int, error) {
	offset := gcontext.Get(r, "offset").(int)
	limit := gcontext.Get(r, "limit").(int)
...
func SearchESContactsDatabase(r *http.Request) (interface{}, int, int, error) {
	offset := gcontext.Get(r, "offset").(int)
	limit := gcontext.Get(r, "limit").(int)
	...
	return searchESContactsDatabase(elasticQuery)
}

func ESCityLocation(r *http.Request, cityName, stateName, countryName string) (interface{}, int, int, error) {
	offset := gcontext.Get(r, "offset").(int)
	limit := gcontext.Get(r, "limit").(int)
	...
	hits, err := elasticLocationCity.QueryStruct(elasticQuery)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func ESStateLocation(r *http.Request, stateName string, countryName string) (interface{}, int, int, error) {
	offset := gcontext.Get(r, "offset").(int)
	limit := gcontext.Get(r, "limit").(int)
	...
	hits, err := elasticLocationState.QueryStruct(elasticQuery)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func ESCountryLocation(r *http.Request, countryName string) (interface{}, int, int, error) {
	if countryName == "" {
		return nil, 0, 0, nil
	}
	...
	hits, err := elasticLocationCountry.Query(offset, limit, search)
	if err != nil {
		log.Printf("%v", err)
		return nil, 0, 0, err
	}
...
func SearchPublicationInESMediaDatabase(r *http.Request, search string) ([]pitchModels.Publication, int, error) {
	...
	hits, err := elasticMediaDatabasePublication.Query(offset, limit, search)
	if err != nil {
		log.Printf("%v", err)
...
func GetMediaDatabaseContactsSchema() (interface{}, error) {
	mapping, err := elasticMediaDatabase.GetMapping()
	if err != nil {
		log.Printf("%v", err)
		return nil, err
	}
